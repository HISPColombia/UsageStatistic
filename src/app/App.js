...
export default React.createClass({
  ...
  async getOuRoot() {
    ...
    try {
      ...
      let rootLevel = await d2.models.organisationUnits.list({ userOnly:true, paging: false, level: 1, fields: 'id,path,displayName,children[id,path,displayName,children::isNotEmpty]' });
      if (rootLevel) {
