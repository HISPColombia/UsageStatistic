...
export default React.createClass({
  ...
  handleDisableUser(user) {
    ...
    api.fetch(this.state.urlPath + '/api/users/'+user.id,{
        method: 'PATCH',
          ...
          <TableRowColumn>
            <IconButton id={row.id} tooltip={(row.userCredentials.disabled === false) ? "Disable" : "Enable"}
              onTouchTap={this.handleDisableUser.bind(this, row)}>
                ...
                <FontIcon color={(row.userCredentials.disabled?"#FF0000":"#00ff00")} className="material-icons">radio_button_checked</FontIcon> 
        ...
        <Paper className='item'>
          ...
          <div>
            ...
            <SelectField value={this.state.type}
              ...
              <span style={{fontSize: 'small', color: 'grey' }}>{d2.i18n.getTranslation('app_lbl_timelogged')}&nbsp;
